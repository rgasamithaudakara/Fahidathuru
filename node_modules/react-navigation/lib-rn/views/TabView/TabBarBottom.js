...
class TabBarBottom extends PureComponent {
  ...
  _renderIcon = scene => {
    ...
    return <TabBarIcon position={position} navigation={navigation} activeTintColor={activeTintColor} inactiveTintColor={inactiveTintColor} renderIcon={renderIcon} scene={scene} style={showLabel && majorVersionIOS >= 11 ? {} : styles.icon} />;
  };
  ...
  render() {
    ...
    return <Animated.View style={[styles.tabBar, style]}>
        ...
        return <TouchableWithoutFeedback key={route.key} testID={testID} accessibilityLabel={accessibilityLabel} onPress={() => onPress ? onPress(scene, jumpToIndex) : jumpToIndex(index)}>
              <Animated.View style={[styles.tab, isLandscape && majorVersionIOS >= 11 && styles.tabLandscape, !isLandscape && majorVersionIOS >= 11 && styles.tabPortrait, { backgroundColor }, tabStyle]}>
